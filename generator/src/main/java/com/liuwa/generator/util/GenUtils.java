...
public class GenUtils
{
     ...
     * 初始化表信息
     */
    public static void initTable(GenTable genTable, Long operUserId)
    {
        ...
        genTable.setCreateBy(operUserId);
    }
    ...
    public static void initColumnField(GenTableColumn column, GenTable table)
    {
        ...
        // 多图片字段设置图片上传控件
        else if (StringUtils.endsWithIgnoreCase(columnName, "images"))
        {
            column.setHtmlType(GenConstants.HTML_MULTI_IMAGE);
        }
        // 文件字段设置文件上传控件

...
public class GlobalProperties {
    ...
    static{
        properties = PropertiesLoader.loadProperties("config.properties", "application.properties", "application.yml");
    }
     ...
     * @return
     */
    public static long getPropertyForLong(String key, String defaultValue) {
        String value = getProperty(key, defaultValue);
        try {
            return Long.parseLong(value);
        } catch (Exception ex) {
     ...
     * @return
     */
    public static float getPropertyForFloat(String key) {
        String value = getProperty(key);
        try {
     ...
     * @return
     */
    public static float getPropertyForFloat(String key, String defaultValue) {
        String value = getProperty(key, defaultValue);
        try {
            return Float.parseFloat(value);
        } catch (Exception ex) {
     ...
     * @return
     */
    public static double getPropertyForDouble(String key, String defaultValue) {
        String value = getProperty(key, defaultValue);
        try {
            return Double.parseDouble(value);
        } catch (Exception ex) {
     ...
     * @return
     */
    public static BigDecimal getPropertyForBigDecimal(String key) {
        String value = getProperty(key);
        try {
     ...
     * @return
     */
    public static BigDecimal getPropertyForBigDecimal(String key, String defaultValue) {
        String value = getProperty(key, defaultValue);
        try {
            return new BigDecimal(value);
        } catch (Exception ex) {

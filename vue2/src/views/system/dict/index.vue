 ...
 <div class="app-container">
  ...
  <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
   ...
   <el-table-column label="数据类型" align="center" prop="dataType">
    <template slot-scope="scope">
     <dict-tag :options="dictDataTypes" :value="scope.row.dataType"/>
    </template>
   </el-table-column>
...
export default {
 ...
 data() {
  return {
   ...
   dateRange: [],
   // 字段数据 类型
   dictDataTypes:[{dictLabel:'字符串', dictValue: 'String'},{dictLabel:'数值', dictValue: 'Number'},{dictLabel:'布尔值', dictValue: 'Boolean'}],
   // 查询参数
   queryParams: {
    pageNum: 1,
    pageSize: 10,
